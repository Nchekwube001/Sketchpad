...
const CurvedScroll = () => {
  const [scrollBarColor, setScrollBarColor] = useState(colors[0]); // Orange by default
  const [showRail, setShowRail] = useState(true);

  const changeColor = () => {
    // Toggle between orange and red
    setScrollBarColor((prev) =>
      prev.color === colors[0].color ? colors[1] : colors[0]
    );
  };
        ...
        <View className="flex-1 bg-zinc-950 px-6 py-6">
          ...
          <View className="mb-8">
            ...
            <Text className="text-base text-gray-400">
              Modern interface with custom scrollbar
            </Text>
          </View>
          ...
          <View className="mb-8 flex-row gap-3">
            ...
            >
              <Text className="mb-1 text-center font-semibold text-white">
                Color
              </Text>
          ...
          <View className="space-y-6">
            ...
            <View className="mb-8 rounded-3xl border border-orange-800/30 bg-gradient-to-br from-orange-900/20 to-orange-900/40 p-8">
              ...
              <Text className="leading-relaxed text-gray-300">
                An elegant scrollbar that perfectly follows screen contours with
                fluid transitions and clean design.
              </Text>
            </View>
              ...
              {Array.from({ length: 20 }, (_, i) => (
                ...
                >
                  ...
                  <Text className="leading-relaxed text-gray-400">
                    Discover how this scrollbar perfectly follows the path along
                    screen edges with smooth and modern animation.
                  </Text>
                </View>
              ))}
            </View>
            ...
            <View className="mb-8 rounded-3xl  p-8">
              ...
              <Text className="leading-relaxed text-gray-300">
                You have reached the end of the content. The scrollbar has
                followed the entire path with elegance!
              </Text>
            </View>
          </View>
        </View>
